...
The main takeaway here is that any attempt to simulate a LTI state space system can be interpreted as an *approximation* of the matrix exponential. There are many ways to do this ([at least nineteen!](https://www.math.purdue.edu/~yipn/543/matrixExp19-I.pdf)), but I will only cover a few here. 
