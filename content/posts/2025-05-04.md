...
draft: false
cover:
    image: "/images/2025-05-04/thumbnail.png"
    alt: "Diagram of the alarm clock"
    relative: false # when using page bundles set this to true
---

So I made my own alarm clock.

It has no snooze button and no off button. It also has a backup battery in case it gets unplugged, and there's no way to remove the battery without a hex key.
...
To close loopholes, you also can't change the alarm or even the date or time without hitting the remote switch. 
...
| ![Schematic.](/images/2025-05-04/schematic.svg) | 
|:--:| 
| *Schematic. It's in vector format, so you can zoom way in.*|
...
First off, I didn't want to deal with JLCPCB's annoying MOQ requirements for PCBA--they were going to force me to buy way more parts than I needed (and their weird consignment system seemed like overkill)--so I only had the boards ordered with the "basic" components assembled (mostly just resistors and caps). This ended up being the worst of both worlds. I was ordering PCBA but also tediously soldering every board. Would not recommend.
...
Anyway, it's finished! And now I get to ship these out to my friends.
