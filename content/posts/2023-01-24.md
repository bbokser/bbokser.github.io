...
Solving an engineering problem requires you to learn everything you can about the subject and the underlying system. Take notes if you have to. Ask people questions.
...
Oftentimes when we become intimidated by one aspect of a project, we instead focus on perfecting some other aspect of it, usually a subject we're more comfortable with. This, of course, is just a waste of time.

Perfectionism isn't necessarily a bad thing, but there is always a time limit for completing a project and you need to budget your time appropriately. This is an extension of #2 (Avoidance), but in this case the avoidance is taken one step further. It's an insidious, subconscious form of procrastination, one that allows us to avoid a task while still feeling smart and productive. Don’t fall for this trap.
