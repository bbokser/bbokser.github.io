...
> "Why is the optimal titanium beam heaviest if titanium has a higher specific strength than aluminum? Shouldn't titanium always be the better choice of the two from a theoretical standpoint?"
...
In most cases, absolutely not! For example, if we were to reduce the outer radius of the aluminum beam down to that of the optimal titanium beam, it would need to be much thicker to meet the requirements. Let's see how that looks: Let's optimize for inner radius $r$ only given a constant outer radius $R$. With an end-effector load of 80 kg:
...
## Conclusion
If I were to get one key takeaway from all of this, it's that second moment of area is more important than specific strength--if you have the space to exploit it.
